...
Now that you have set up the demo, you can explore the service catalog features and functionalities in the [user walkthrough documentation](user-walkthrough).
