...
This walkthrough will guide you through the steps to run the demo from a user perspective. It assumes you have already set up the environment as described in the [installation guide](https://docs.infrahub.app/demo-service-catalog/installation).
...
Your request will be submitted to Infrahub, where it will be processed by the network architect.
